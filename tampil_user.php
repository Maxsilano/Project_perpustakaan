            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="tampil_user.php">Data User</a>
                                ...
                                <tbody>
                                    ...
                                    while ($data_user = mysqli_fetch_array($qry_user)) {
                                        ...
                                        <tr>
                                            ...
                                            <a href="hapus_user.php?id=<?= $data_user['id'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
